<template>
    ...
    <br>Wir haben diese Web-App im Rahmen des einwöchigen Coding-Camps welches die Sybit GmbH jährlich veranstaltet entworfen, entwickelt und programmiert.
    <br>Der Gedanke dahinter war, dass wir das Ferienprogramm für Kinder der Stadt Radolfzell, welches bisher analog als Heftchen vorlag, digitalisieren und so noch mehr Kinder, Jugendliche aber auch Eltern erreicht werden.
